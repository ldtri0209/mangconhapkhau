...
class JSON_API {
  ...
  function template_redirect() {
    ...
    $enabled_controllers = explode(',', get_option('json_api_controllers', 'ip_core'));
  ...
  function admin_menu() {
    add_options_page('IDEAPRESS JSON API Settings', 'IDEAPRESS JSON API', 'manage_options', 'json-api', array(&$this, 'admin_options'));
  }
...
<div class="wrap">
  ...
  <h2>IDEAPRESS JSON API Settings</h2>
