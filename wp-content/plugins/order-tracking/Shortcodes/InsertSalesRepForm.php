...
function Insert_Sales_Rep_Form($atts) {
	...
	$Email_Confirmation = get_option("EWD_OTP_Sales_Rep_Confirmation");
	...
	extract( shortcode_atts( array(
				...
				'order_field_text' => __('Sales Rep Number', 'EWD_OTP'),
				'email_field_text' => __('Sales Rep E-mail', 'EWD_OTP'),
				'email_field_shortcode' => '',
				'email_field_shortcode_attribute' => '',
				'email_field_attribute_value' => '',
				'order_instructions' => __('Enter your sales rep number in the form below to track your orders.', 'EWD_OTP'),
				'field_names' => '',
	...
	if (isset($_POST['Sales_Rep_ID'])) {
		...
		$ReturnString .= EWD_OTP_Return_Sales_Rep_Results($_POST['Sales_Rep_ID'], $Fields, $_POST['Sales_Rep_Email']);
		$ReturnString .= "</div>";
	}
